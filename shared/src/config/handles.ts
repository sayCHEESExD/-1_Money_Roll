...
const SECOND = [
  'Roller', 'Tycoon', 'Banker', 'Comet', 'Bolt', 'Dash', 'Miner', 'Baron',
  'Cashier', 'Mogul', 'Vault', 'Coin', 'Racer', 'Charger', 'Halo', 'Nova',
] as const;
...
/** The handle a player id is keyed as, e.g. `@SwiftRoller_2F91`. */
export const handleFor = (playerId: string): string => {
  if (!playerId) return '@Roller_0000';
