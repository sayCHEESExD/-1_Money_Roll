import { VISIBLE_REMOTE_PLAYERS } from '@money/shared';
 ...
 * nearest are DRAWN - character, ball, pets, aura and bridge - so a full room
 * cannot cost every client fifteen of everything.
 */
export class RemotePlayerManager {
  ...
  /** True when the set of drawn players changed, so the bridges redraw. */
  ...
  /** The drawn remotes, for the bridge renderer. */
  *drawn(): IterableIterator<RemotePlayer> {
